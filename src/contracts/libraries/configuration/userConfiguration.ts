export class UserConfiguration {
    ...
    isUsingAsCollateralOrBorrowing(reserveIndex: number): boolean {
        ...
        return this.borrowingStatus[reserveIndex] || this.collateralStatus[reserveIndex];
    }
     ...
     */
    isEmpty(): boolean {
        return !this.borrowingStatus.includes(true) && !this.collateralStatus.includes(true);
    }
}
